...
_Generated by `./scripts/studio-status.sh`. Native numbers come from Xcode / Gradle._
...
| Android | 1.0 | 13 | Play production live (uploaded binary still 9 until this AAB) |
