...
Lived-in data, light mode. Skip OTP, empty lists, Delete account, and discussion.
...
- Sign-in required: **Yes**. OTP only. QA: `supabase/seed/QA_TRIO.md`
- Age rating: User-Generated Content **Yes**; not Made for Kids
- Privacy: collect name, email, phone, photos, other user content, user ID, device ID — linked to identity, not tracking, app functionality. No location/ads/analytics/purchases declared.
- Account deletion in-app required
