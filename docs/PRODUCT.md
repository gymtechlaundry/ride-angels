...
**Status (verified):** shipped / focus `active`. Android: Google Play **production** (public listing live). iOS: App Store **production** 1.0.

**Repo binaries:** iOS 1.0 / 12 / production (Xcode next 13); Android 1.0 / 13 / production.

**Next:** Ship push notifications (P0 in docs/future-features.md). Next iOS binary is 13; next Play AAB is versionCode 14+.
